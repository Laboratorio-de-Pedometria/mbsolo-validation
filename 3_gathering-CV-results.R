...
write_xlsx(cv_results, "results/cv_results.xlsx", col_names = TRUE)

# Biome-wise standard cross-validation statistics -------------------------

# Carregando dados originais e definindo novamente a versão dos dados
input_data_path <- "data/"
original_data <- read_csv(paste0(input_data_path, "/matriz_soc_pred_Cbeta_v1_7_4.csv"))
data_version <- "Cbeta_v1_7_4"
...
models_path <- "models/tuned-models_Cbeta_v1_7_4/" # Define o caminho para os modelos ajustados
...
write_xlsx(biome_cv_results,
           path = paste0("results/cv_Cbeta_v1_7_4/",
                         "each_biome-cross_validation-results_Cbeta_v1_7_4.xlsx"),
           col_names = TRUE)
